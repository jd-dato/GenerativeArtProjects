...
**I have to be honest**, I relied very much on the provided documentation of the package and ChatGPT to start working. The first image, which I have titled, *The Path to Hell*, was made entirely by me. I used a large uniform distribution to run some simple equations in, and set the output colors to red and black in a Polar grid.
